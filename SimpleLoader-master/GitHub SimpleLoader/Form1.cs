...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            string HWIDLIST = wb.DownloadString("https://raw.githubusercontent.com/SmokiDK/HackProject/master/hwid.txt"); //Replace "HWID List URL" with your own URL to a RAW text (txt) file with all your wanted HWIDs [Example: http://myurl.com/HWID.txt]
            ...
            {
                MessageBox.Show("This is hwid protected... Fuck off");
            }
        }
